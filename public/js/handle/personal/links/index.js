...
//     const LoadDataMyShortLink = (page = 1,status=0 ,box_show)=>{
//         GetDataMyShortlink(page,status,(data)=>{            
//             if(data.data.length==0)
//                 return box_show.html("<center><h4>No data found</h4></center>");
//             box_show.html("")            
...
//                                     <h4 class="link-title">${item.title ?? "No title yet"} ${item.password ? "<i class='bx bxs-lock-alt'></i>" : ""}</h4>
...
//                                         s+=`<span class="my-short-link-start-day">${ConvertDateTimeToString(item.effective_time)}</span><i class='bx bx-time-five' ></i>`
//                                     s+=`</i><span class="my-short-link-end-day"> ${ConvertDateTimeToString(item.expired)}</span><br>
//                                     <span>
...
//                 LoadDataMyShortLink(page,status,box_show)
//             })            
//         })            
//     }
...
//         if(parseInt(id) == NaN)   
//             return;        
//         UpdateMyShortLink(id,formData,(res)=>{  
//             //console.log(res)              
//             if(res.success)
//             {
...
//         tab.click(function(){
//             LoadDataMyShortLink(1,index,tab_pane)
//         })        
//     }
//     LoadDataMyShortLink(1,0,$(tab_panes[0]))
// })
